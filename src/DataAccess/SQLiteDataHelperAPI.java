 ...
 */
public abstract class SQLiteDataHelperAPI {
    private static String DBPathConnection = "https://pokeapi.co/api/v2/";
    private static Connection conn = null;
    public SQLiteDataHelperAPI(String  dbPathConnection){
        // Definir la cadena de conneccion : jdbc:sqlite:data\\TinderPet.db
        if (!dbPathConnection.isEmpty())
        SQLiteDataHelperAPI.DBPathConnection = dbPathConnection;
    }
    /**
